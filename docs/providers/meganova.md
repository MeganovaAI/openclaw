...
[MegaNova AI](https://meganova.ai) provides access to 50+ leading models through
an OpenAI-compatible API, including frontier models (Claude, GPT-5, Gemini),
open-source models (DeepSeek, Llama, Qwen), reasoning models (GLM-5, DeepSeek-R1),
and community roleplay models.
...
- **GLM 5** (default) - 744B MoE reasoning model, 202K context
- **Manta Mini / Flash / Pro** - MegaNova's own models, free tier
...
- **DeepSeek V3.2 / V3.1 / R1-0528** - Open-weight reasoning and coding models
- **Kimi K2 Thinking / K2.5** - Moonshot reasoning models
- **Qwen3 235B / Qwen 2.5 VL** - Alibaba multilingual and vision models
- **Llama 3.3 70B Instruct** - Meta open-source model
- **Cydonia, Euryale, Sapphira, Violet-Lotus, Nevoria, Stheno** - Community roleplay models
